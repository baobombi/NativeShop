...
//Handle check request Permission, getToken, listener from firebase
...
class FCMService {
  ...
  buidlNotification = obj => {
    ...
    ); //Auto cancel after receive notification
  };
  ...
  displayNotification = notification => {
    firebase
      ...
      .displayNotification(notification)
      .catch(error => {
        console.log('Display Notification: ', error);
      });
  };
